...
# # Antes da alteração
# print("Antes da alteração do Carro04:")
...
# # Depois da alteração
# print("\nDepois da alteração do Carro04:")
# print(f"Carro04 - Marca: {Carro04.marca}, Modelo: {Carro04.modelo}, Ano: {Carro04.ano}")
...
# ContaBancaria01 = ContaBancaria("12586-1", "João")
# ContaBancaria02 = ContaBancaria("16254-0", "Maria")
# ContaBancaria03 = ContaBancaria("11364-8", "Claudia")

# # Imprimindo os dados da conta
# print(f"ContaBancaria01 - Número da conta: {ContaBancaria01.num_conta}, Titular: {ContaBancaria01.titular}, Saldo: {ContaBancaria01.saldo}")
# print(f"ContaBancaria02 - Número da conta: {ContaBancaria02.num_conta}, Titular: {ContaBancaria02.titular}, Saldo: {ContaBancaria02.saldo}")
# print(f"ContaBancaria03 - Número da conta: {ContaBancaria03.num_conta}, Titular: {ContaBancaria03.titular}, Saldo: {ContaBancaria03.saldo}")
...
# if conta.sacar(50):
#     print("Saque de R$50 realizado com sucesso!")
# else:
#     print("Falha no saque de R$50.")

# # Tentando saque de R$300 (vai falhar)
# if conta.sacar(300):
#     print("Saque de R$300 realizado com sucesso!")
# else:
#     print("Falha no saque de R$300 (saldo insuficiente).")
...
# print("Espécie (pelo objeto):", dog1.especie)
